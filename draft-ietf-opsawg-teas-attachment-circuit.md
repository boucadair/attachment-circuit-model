...
'server-reference':
: Reports the internal reference that is assigned by the provider for this AC. This reference is used to accomodate deployment contexts (e.g., {{Section 9.1.2 of ?RFC8921}}) where an identifier is generated by the server to identify a service order locally.
